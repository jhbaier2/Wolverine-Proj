...
Finally, what we are left with is a graph with the noise removed. In addition, we can definitively say that there is a positive correlation between the move ratio and the standard deviation. The other three SD measures (3/7/10) are displayed in the appendix as each shows the same relationship. In short, this graph details the fact that, yes a large move or "jump" will be followed by continued jumps. 
